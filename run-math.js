...
//var RM = requre('run-math');
//var rm= new RM();



module.exports = class RunMath{
    getSummary(fullRunData,wucdtime,maxhr) {
    ...
    average (arr,field)
    {
	 ...
	 getRunWithOutWUCD(sumData,warmUpMin){
	    var out=[];
    ...
    getRMSSDTotalSquared(allRecords) {
	    var total=0;
	    var lastNumber=0;
	    var curValue=0;
	 ...
	 getRollingAverage(data,currentIndex,rollDays){
	 ...
	 getSumData30Sec(allIntervalsIn){
	...
	getNGP(speedKm, distanceMeters, elevationUpMeters, elevationDownMeters){
